...
fn main(){
    ...
    timely::execute_from_args(std::env::args(), move |worker| {
        ...
        let t_box_deletion_path = "C:\\Users\\xhimi\\Documents\\University\\THESIS\\data\\example\\example_data\\t_box_deletion_test.nt";
        let a_box_deletion_path = "C:\\Users\\xhimi\\Documents\\University\\THESIS\\data\\example\\example_data\\a_box_deletion_test.nt";
        ...
        let incremental_materialization_addition_and_deletion_output_path = format!("C:\\Users\\xhimi\\Documents\\University\\THESIS\\data\\example\\result\\with_addition_and_deletion\\with_addition_and_deletion_peers{}\\example_deletion_worker{}.nt", peers, index);
        ...
        // WARNING: Shouldn't this be the same as for removals? where everyworker should add the same data for t_box?
        ...
        // Ok, no idea how this work. I realized that the workers when starting with the full materialization
        // they all load the t_box, which is something that I plan to fix, so now to remove the data I need
        // to follow the  same "mistake", where every worker adds all the changes in the t_box and the 
        // part of the a_box it pertains to them, madness imho. HOW TO FIX THIS: PROBABLY BY PARALLELIZING THE T_BOX
        ...
        reasoning_service::remove_data(a_box_batch_del, &mut data_input, t_box_batch_del, 3);
        ...
        reasoning_service::save_to_file_through_trace(&incremental_materialization_addition_and_deletion_output_path, &mut result_trace, 3);
