...
fn main(){
    ...
    let worker_guard = 
        timely::execute_from_args(std::env::args(), move |worker| {
            ...
            let t_box_deletion_path = "C:\\Users\\xhimi\\Documents\\University\\THESIS\\data\\LUBM\\updates\\remove_update4\\update.nt";            
            ...
            reasoning_service::remove_data(vec![], &mut data_input, t_box_batch_del, 2);
            ...
            if index == 0 {
                println!("Deletion update time: {}ms", timer.elapsed().as_millis());
                timer = std::time::Instant::now();
            }
    ...
    let inc_materialization_output_path = format!("C:\\Users\\xhimi\\Documents\\University\\THESIS\\data\\LUBM\\LUBM{}\\result\\with_deletion\\update4\\lubm{}_del_u4_peers{}.nt", universities, universities, peers);
