...
fn main(){
    ...
    let worker_guard = 
        timely::execute_from_args(std::env::args(), move |worker| {
            ...
            let a_box_deletion_path = "C:\\Users\\xhimi\\Documents\\University\\THESIS\\data\\LUBM\\updates\\remove_update5\\update.nt";            
    ...
    let inc_materialization_output_path = format!("C:\\Users\\xhimi\\Documents\\University\\THESIS\\data\\LUBM\\LUBM{}\\result\\with_deletion\\update5\\lubm{}_del_u5_peers{}.nt", universities, universities, peers);
